def get_wquantizer(block_idx, layer_name, mix_bits_map, quantizer_mix_bits, wquantizer_default):
    ...
    for layer_name_substring in mix_bits_map_this_block:
        if layer_name_substring in layer_name:
            quantizer_mix_bits_this_layer = quantizer_mix_bits[mix_bits_map_this_block[layer_name_substring]]
...
def get_aquantizer(block_idx, layer_name, mix_bits_map, quantizer_mix_bits, aquantizer_default):
    mix_bits_map_this_block = mix_bits_map[block_idx]
    for layer_name_substring in mix_bits_map_this_block:
        if layer_name_substring in layer_name:
            quantizer_mix_bits_this_layer = quantizer_mix_bits[mix_bits_map_this_block[layer_name_substring]]
