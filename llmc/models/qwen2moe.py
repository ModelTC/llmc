    ...
    def get_subsets_in_block(self, block):
        ...
        if hasattr(block.mlp, "gate"):
            layers.append(
                {
                    'layers': {
                        **{f'mlp.experts.{i}.gate_proj': block.mlp.experts[i].gate_proj for i in range(len(block.mlp.experts))},
                        **{f'mlp.experts.{i}.up_proj': block.mlp.experts[i].up_proj for i in range(len(block.mlp.experts))},
                        'mlp.shared_expert.gate_proj': block.mlp.shared_expert.gate_proj,
                        'mlp.shared_expert.up_proj': block.mlp.shared_expert.up_proj,
                    },
            ...
            for i in range(len(block.mlp.experts)):
                layers.append(
                    {
                        'layers': {f'mlp.experts.{i}.down_proj': block.mlp.experts[i].down_proj},
            ...
            layers.append(
                {
                    'layers': {'mlp.shared_expert.down_proj': block.mlp.shared_expert.down_proj},
